    ...
    lessons: [
      {
        ...
        summary: 'Variables, expressions, and basic algebraic operations.',
        concept:
          'Algebra uses letters to represent unknown numbers. Expressions combine variables, numbers, and operations. Evaluate expressions by substituting values and following order of operations.',
        keywords: ['variable', 'expression', 'substitution', 'evaluate'],
        exercise:
          'Evaluate 3x + 2 when x = 5. Then evaluate 2(x + 3) - x when x = 4.',
        reflection:
          'Why do we use variables in algebra? How does substitution help us understand expressions?',
        terms: {
          title: 'Algebra Basics',
          items: [
            { term: 'Variable', def: 'A letter representing an unknown number' },
            { term: 'Expression', def: 'Combination of numbers, variables, and operations' },
            { term: 'Coefficient', def: 'Number multiplying a variable' },
            { term: 'Constant', def: 'Number without a variable' }
          ]
        },
        quiz: {
          ...
          options: ['11', '16', '8', '6'],
          answerIndex: 0,
          hint: 'Substitute 3 for x and calculate.'
        }
      },
      {
        title: 'UNIT 2: Solving Equations & Inequalities',
        summary: 'Find unknown values using inverse operations.',
        concept:
          'Equations show equality between expressions. Use inverse operations to isolate variables: add/subtract to undo, multiply/divide to undo. Maintain balance by doing same operation to both sides.',
        keywords: ['equation', 'inverse operations', 'isolate variable', 'balance'],
        exercise:
          'Solve: 2x + 5 = 17. Then solve: 3(x - 2) = 12.',
        reflection:
          'Why must we perform the same operation on both sides of an equation?',
        flow: {
          title: 'Solving Equations',
          steps: ['Identify variable', 'Undo operations in reverse order', 'Maintain balance', 'Check solution']
        },
        terms: {
          title: 'Equation Solving',
          items: [
            { term: 'Inverse Operation', def: 'Opposite operation that undoes another' },
            { term: 'Isolate Variable', def: 'Get variable alone on one side' },
            { term: 'Solution', def: 'Value that makes equation true' },
            { term: 'Check', def: 'Substitute solution to verify' }
          ]
        },
        quiz: {
          question: 'Solve: x/3 + 2 = 5',
          options: ['x = 9', 'x = 3', 'x = 7', 'x = 1'],
          answerIndex: 0,
      ...
      },
      {
        ...
        summary: 'Convert between different units of measurement.',
        concept:
          'Units must be consistent for calculations. Use conversion factors to change units. Multiply by conversion factor (fraction equal to 1) to cancel unwanted units.',
        keywords: ['conversion factor', 'dimensional analysis', 'cancel units'],
        exercise:
          'Convert 5 feet to inches. Convert 2.5 hours to minutes.',
        reflection:
          'Why is it important to include units in calculations?',
        sorter: {
          prompt: 'Match units to their conversion factors',
          items: [
            '1 foot = 12 inches',
            '1 yard = 3 feet',
            '1 hour = 60 minutes',
        ...
        terms: {
          ...
          items: [
            { term: 'Conversion Factor', def: 'Ratio equal to 1 used to change units' },
            { term: 'Dimensional Analysis', def: 'Method using units to guide calculations' },
            { term: 'Cancel Units', def: 'Units should cancel out in correct calculations' }
          ]
        },
        quiz: {
          question: 'How many centimeters in 2 meters?',
          options: ['20', '200', '2000', '0.02'],
          answerIndex: 1,
      ...
      },
      {
        ...
        summary: 'Represent linear relationships graphically.',
        concept:
          'Linear equations have constant rate of change. Graph as straight line. Slope measures steepness, y-intercept is starting value. Equation form: y = mx + b.',
        keywords: ['slope', 'y-intercept', 'linear relationship', 'graph'],
        exercise:
          'Graph y = 2x + 1. Find slope and y-intercept.',
        reflection:
          'How does slope represent rate of change?',
        terms: {
          title: 'Linear Graphing',
          items: [
            { term: 'Slope (m)', def: 'Rise over run, measures steepness' },
            { term: 'Y-intercept (b)', def: 'Where line crosses y-axis' },
            { term: 'Rise', def: 'Vertical change between points' },
            { term: 'Run', def: 'Horizontal change between points' }
          ]
        },
        useCases: {
          title: 'Linear Relationships',
          items: [
            { title: 'Distance vs Time', desc: 'Constant speed creates linear relationship' },
            { title: 'Cost vs Quantity', desc: 'Fixed price per item' },
            { title: 'Temperature vs Time', desc: 'Constant heating/cooling rate' }
          ]
        },
        quiz: {
          ...
          options: ['3', '-2', '1', '0'],
          answerIndex: 0,
          hint: 'Slope is coefficient of x.'
        }
      },
      {
        title: 'UNIT 5: Forms of Linear Equations',
        summary: 'Different ways to write linear equations.',
        concept:
          'Slope-intercept: y = mx + b. Point-slope: y - y₁ = m(x - x₁). Standard: Ax + By = C. Convert between forms to solve different problems.',
        keywords: ['slope-intercept', 'point-slope', 'standard form'],
        exercise:
          'Convert y = 2x + 3 to standard form. Convert 2x + 3y = 6 to slope-intercept form.',
        reflection:
          'When would you use each form of linear equations?',
        sorter: {
          prompt: 'Match equation forms to their uses',
          items: [
            'y = mx + b',
            'y - y₁ = m(x - x₁)',
            'Ax + By = C'
          ...
          solution: {
            'Graphing': ['y = mx + b'],
            'Point and slope known': ['y - y₁ = m(x - x₁)'],
            'Integer coefficients': ['Ax + By = C']
          }
        },
        terms: {
          title: 'Equation Forms',
          items: [
            { term: 'Slope-Intercept', def: 'y = mx + b, easy to graph' },
            { term: 'Point-Slope', def: 'y - y₁ = m(x - x₁), uses known point' },
            { term: 'Standard Form', def: 'Ax + By = C, integer coefficients' }
          ]
        },
        quiz: {
          question: 'Which form is easiest to graph?',
          options: ['Slope-intercept', 'Point-slope', 'Standard', 'All equally easy'],
          answerIndex: 0,
          hint: 'Look for slope and intercept directly.'
        }
      },
      {
        title: 'UNIT 6: Systems of Equations',
        summary: 'Solve multiple equations simultaneously.',
        concept:
          'Systems have multiple equations and variables. Solutions satisfy all equations. Methods: substitution, elimination, graphing. Consistent systems have one solution, inconsistent have none.',
        keywords: ['system', 'substitution', 'elimination', 'consistent'],
        exercise:
          'Solve: y = 2x + 1 and y = x + 3. Use both substitution and elimination.',
        reflection:
          'When would you choose substitution vs elimination?',
        flow: {
          title: 'Solving Systems',
          steps: ['Choose method', 'Solve one equation for variable', 'Substitute into other equation', 'Solve for remaining variable', 'Check solution']
        },
        terms: {
          title: 'System Concepts',
          items: [
            { term: 'Consistent', def: 'Has at least one solution' },
            { term: 'Inconsistent', def: 'No solution (parallel lines)' },
            { term: 'Dependent', def: 'Infinite solutions (same line)' },
            { term: 'Independent', def: 'Exactly one solution' }
          ]
        },
        quiz: {
          question: 'How many solutions for consistent independent system?',
          options: ['0', '1', '2', 'Infinite'],
          answerIndex: 1,
          hint: 'Lines intersect at one point.'
        }
      },
      {
        title: 'UNIT 7: Inequalities (Systems & Graphs)',
        summary: 'Solve and graph inequality relationships.',
        concept:
          'Inequalities use <, >, ≤, ≥. Solutions are ranges of values. Graph as shaded regions. Systems combine multiple inequalities.',
        keywords: ['inequality', 'shaded region', 'boundary line'],
        exercise:
          'Solve and graph: 2x + 1 > 5. Then graph system: y > x and y < 2x + 1.',
        reflection:
          'How do inequality graphs differ from equation graphs?',
        terms: {
          title: 'Inequality Graphing',
          items: [
            { term: 'Boundary Line', def: 'Line separating shaded and unshaded regions' },
            { term: 'Shaded Region', def: 'Area containing solutions' },
            { term: 'Test Point', def: 'Point used to determine which side to shade' },
            { term: 'Half-plane', def: 'Region on one side of boundary line' }
          ]
        },
        useCases: {
          title: 'Inequality Applications',
          items: [
            { title: 'Budget Constraints', desc: 'Income ≥ expenses' },
            { title: 'Grade Requirements', desc: 'Score ≥ 70%' },
            { title: 'Resource Limits', desc: 'Usage ≤ capacity' }
          ]
        },
        quiz: {
          question: 'For y > 2x + 1, shade above or below boundary?',
          options: ['Above', 'Below', 'Both sides', 'Neither'],
          answerIndex: 0,
          hint: 'Test point (0,0): 0 > 1? False, so shade other side.'
        }
      },
      {
        title: 'UNIT 8: Functions',
        summary: 'Relationships where each input has exactly one output.',
        concept:
          'Functions map inputs to outputs. Domain is all possible inputs, range is all possible outputs. Vertical line test determines if relation is function.',
        keywords: ['function', 'domain', 'range', 'vertical line test'],
        exercise:
          'Determine if each relation is a function: (1,2), (2,3), (3,2) vs (1,2), (1,3), (2,4).',
        reflection:
          'Why are functions important in mathematics and real life?',
        terms: {
          title: 'Function Concepts',
          items: [
            { term: 'Domain', def: 'Set of all possible input values' },
            { term: 'Range', def: 'Set of all possible output values' },
            { term: 'Independent Variable', def: 'Input value (usually x)' },
            { term: 'Dependent Variable', def: 'Output value (usually y)' }
          ]
        },
        useCases: {
          title: 'Function Examples',
          items: [
            { title: 'Temperature Conversion', desc: 'Celsius to Fahrenheit' },
            { title: 'Distance Calculation', desc: 'Speed × time' },
            { title: 'Cost Functions', desc: 'Price per item × quantity' }
          ]
        },
        quiz: {
          question: 'Which relation is NOT a function?',
          options: ['y = 2x + 1', 'x = y²', 'y = x²', 'y = |x|'],
          answerIndex: 1,
          hint: 'Vertical line test fails.'
        }
      },
      {
        title: 'UNIT 9: Sequences',
        summary: 'Ordered lists of numbers following patterns.',
        concept:
          'Sequences are ordered lists. Arithmetic sequences add constant difference. Geometric sequences multiply by constant ratio. Find nth term formulas.',
        keywords: ['sequence', 'arithmetic', 'geometric', 'common difference'],
        exercise:
          'Find next 3 terms: 2, 5, 8, 11, ... Find nth term formula.',
        reflection:
          'How do sequences model real-world patterns?',
        terms: {
          title: 'Sequence Types',
          items: [
            { term: 'Arithmetic', def: 'Constant difference between terms' },
            { term: 'Geometric', def: 'Constant ratio between terms' },
            { term: 'Common Difference', def: 'd = term₂ - term₁' },
            { term: 'Common Ratio', def: 'r = term₂ ÷ term₁' }
          ]
        },
        useCases: {
          title: 'Sequence Applications',
          items: [
            { title: 'Population Growth', desc: 'Geometric sequences' },
            { title: 'Savings Plans', desc: 'Arithmetic or geometric' },
            { title: 'Compound Interest', desc: 'Geometric growth' }
          ]
        },
        quiz: {
          question: 'Sequence 3, 6, 12, 24, ... is:',
          options: ['Arithmetic', 'Geometric', 'Neither', 'Both'],
          answerIndex: 1,
          hint: 'Check if ratio is constant.'
        }
      },
      {
        title: 'UNIT 10: Absolute Value & Piecewise Functions',
        summary: 'Functions with multiple rules and absolute values.',
        concept:
          'Absolute value |x| is distance from zero. Piecewise functions have different rules for different domains. Graph by evaluating each piece separately.',
        keywords: ['absolute value', 'piecewise', 'domain restrictions'],
        exercise:
          'Graph y = |x| and y = |x - 2|. Create piecewise function for postage costs.',
        reflection:
          'Why do we need piecewise functions?',
        terms: {
          title: 'Absolute Value & Piecewise',
          items: [
            { term: 'Absolute Value', def: '|x| = x if x ≥ 0, -x if x < 0' },
            { term: 'Piecewise Function', def: 'Function with different rules for different intervals' },
            { term: 'Domain Restriction', def: 'Limits where function is defined' },
            { term: 'Break Point', def: 'Where function rule changes' }
          ]
        },
        useCases: {
          title: 'Real-World Piecewise',
          items: [
            { title: 'Tax Brackets', desc: 'Different rates for different income levels' },
            { title: 'Utility Bills', desc: 'Tiered pricing structures' },
            { title: 'Shipping Costs', desc: 'Different rates for different weights' }
          ]
        },
        quiz: {
          question: 'What is | -5 |?',
      ...
      },
      {
        ...
        summary: 'Powers, roots, and their properties.',
        concept:
          'Exponents show repeated multiplication. Radicals (roots) are inverse of exponents. Properties: x^a × x^b = x^(a+b), (x^a)^b = x^(ab), x^0 = 1.',
        keywords: ['exponent', 'radical', 'power', 'root'],
        exercise:
          'Simplify: x^3 × x^2. Evaluate: 2^3 × 2^4. Find √(16) and ∛(27).',
        reflection:
          'How do exponents and radicals relate to each other?',
        terms: {
          title: 'Exponent & Radical Terms',
          items: [
            { term: 'Base', def: 'Number being multiplied (2 in 2^3)' },
            { term: 'Exponent', def: 'Number of times base is multiplied' },
            { term: 'Radical', def: 'Root symbol (√ for square root)' },
            { term: 'Index', def: 'Type of root (2 for square, 3 for cube)' }
          ]
        },
        useCases: {
          title: 'Exponent Applications',
          items: [
            { title: 'Area Calculations', desc: 'Length squared for area' },
            { title: 'Population Models', desc: 'Exponential growth/decay' },
            { title: 'Scientific Notation', desc: 'Very large/small numbers' }
          ]
        },
        quiz: {
          question: 'Simplify: x^2 × x^3',
          options: ['x^5', 'x^6', '2x^3', 'x^2 + x^3'],
          answerIndex: 0,
      ...
      },
      {
        ...
        summary: 'Models with constant percentage change.',
        concept:
          'Exponential functions: y = a(1+r)^t for growth, y = a(1-r)^t for decay. Half-life and doubling time characterize rates. Graph as curves, not lines.',
        keywords: ['exponential', 'growth', 'decay', 'half-life'],
        exercise:
          'Population grows 5% annually from 1000. Find size after 3 years.',
        reflection:
          'Why do exponential models appear in so many real-world situations?',
        terms: {
          title: 'Exponential Concepts',
          items: [
            { term: 'Growth Factor', def: '1 + r (multiplier for growth)' },
            { term: 'Decay Factor', def: '1 - r (multiplier for decay)' },
            { term: 'Half-life', def: 'Time for quantity to reduce by half' },
            { term: 'Doubling Time', def: 'Time for quantity to double' }
          ]
        },
        useCases: {
          title: 'Exponential Applications',
          items: [
            { title: 'Population Growth', desc: 'Birth rates exceed death rates' },
            { title: 'Radioactive Decay', desc: 'Unstable atoms breaking down' },
            { title: 'Compound Interest', desc: 'Interest on interest' },
            { title: 'Bacterial Growth', desc: 'Division every fixed time period' }
          ]
        },
        quiz: {
          question: 'For 8% annual growth, growth factor is:',
          options: ['0.08', '1.08', '8', '0.92'],
          answerIndex: 1,
      ...
      },
      {
        ...
        summary: 'Work with quadratic expressions and equations.',
        concept:
          'Quadratics have x² terms. Multiply using FOIL or distributive property. Factor by finding numbers that multiply to constant term and add to x-coefficient.',
        keywords: ['quadratic', 'FOIL', 'factor', 'trinomial'],
        exercise:
          'Multiply: (x + 2)(x + 3). Factor: x² + 5x + 6.',
        reflection:
          'Why is factoring the reverse of multiplication?',
        flow: {
          title: 'Factoring Process',
          steps: ['Find factors of constant term', 'Find pair that sums to x-coefficient', 'Write as (x + a)(x + b)', 'Verify by multiplying']
        },
        terms: {
          title: 'Quadratic Operations',
          items: [
            { term: 'FOIL', def: 'First, Outer, Inner, Last multiplication method' },
            { term: 'Difference of Squares', def: 'a² - b² = (a - b)(a + b)' },
            { term: 'Perfect Square', def: 'a² + 2ab + b² = (a + b)²' },
            { term: 'Zero Product Property', def: 'If ab = 0, then a = 0 or b = 0' }
          ]
        },
        quiz: {
          question: 'Factor: x² - 9',
          options: ['(x - 3)(x + 3)', '(x - 9)(x + 1)', 'Cannot factor', '(x - 3)²'],
          answerIndex: 0,
      ...
      },
      {
        ...
        summary: 'Solve and graph quadratic equations.',
        concept:
          'Quadratic equation: ax² + bx + c = 0. Solutions by factoring, completing square, or quadratic formula. Graph is parabola with vertex at minimum/maximum.',
        keywords: ['parabola', 'vertex', 'quadratic formula', 'discriminant'],
        exercise:
          'Solve: x² - 5x + 6 = 0. Graph y = x² - 4x + 3.',
        reflection:
          'How do quadratic graphs differ from linear graphs?',
        terms: {
          title: 'Quadratic Features',
          items: [
            { term: 'Vertex', def: 'Maximum or minimum point of parabola' },
            { term: 'Axis of Symmetry', def: 'Vertical line through vertex' },
            { term: 'Discriminant', def: 'b² - 4ac determines number of solutions' },
            { term: 'Roots', def: 'x-intercepts (solutions to equation)' }
          ]
        },
        useCases: {
          title: 'Quadratic Applications',
          items: [
            { title: 'Projectile Motion', desc: 'Height as function of time' },
            { title: 'Area Optimization', desc: 'Maximum area for given perimeter' },
            { title: 'Profit Maximization', desc: 'Revenue minus cost functions' }
          ]
        },
        quiz: {
          question: 'For y = x² - 4x + 3, vertex is at:',
          options: ['(2, -1)', '(2, 1)', '(-2, 3)', '(0, 3)'],
          answerIndex: 0,
          hint: 'x = -b/(2a), then substitute to find y.'
        }
      },
      {
        title: 'UNIT 15: Irrational Numbers',
        summary: 'Numbers that cannot be expressed as fractions.',
        concept:
          'Irrational numbers have non-repeating, non-terminating decimals. Include √2, π, e. Cannot be expressed as p/q where p and q are integers.',
        keywords: ['irrational', 'non-terminating', 'non-repeating', 'transcendental'],
        exercise:
          'Classify: √4, √2, 0.5, π, 3.14159..., √9.',
        reflection:
          'Why are irrational numbers necessary?',
        terms: {
          title: 'Number Types',
          items: [
            { term: 'Rational', def: 'Can be written as fraction p/q' },
            { term: 'Irrational', def: 'Cannot be written as fraction' },
            { term: 'Transcendental', def: 'Not root of any polynomial equation' },
            { term: 'Algebraic', def: 'Root of polynomial with rational coefficients' }
          ]
        },
        useCases: {
          title: 'Irrational Applications',
          items: [
            { title: 'Geometry', desc: 'Diagonal of unit square is √2' },
            { title: 'Trigonometry', desc: 'π for circles, e for growth' },
            { title: 'Physics', desc: 'Natural constants and measurements' }
          ]
        },
        quiz: {
          ...
          options: ['√4', '√9', '√2', '0.5'],
          answerIndex: 2,
          hint: 'Cannot be expressed as fraction.'
        }
      },
      {
        title: 'UNIT 16: Creativity in Algebra',
        summary: 'Apply algebraic thinking to solve problems creatively.',
        concept:
          'Algebra provides tools to model and solve real-world problems. Break complex problems into simpler parts, identify patterns, and create mathematical representations.',
        keywords: ['problem solving', 'modeling', 'patterns', 'representation'],
        exercise:
          'A rectangle has perimeter 20. Express area in terms of width, then find maximum area.',
        reflection:
          'How does algebraic thinking help solve real-world problems?',
        terms: {
          title: 'Problem Solving',
          items: [
            { term: 'Model', def: 'Create mathematical representation of problem' },
            { term: 'Variable', def: 'Unknown quantity to find' },
            { term: 'Constraint', def: 'Limitation or condition' },
            { term: 'Optimization', def: 'Finding maximum or minimum value' }
          ]
        },
        useCases: {
          title: 'Algebraic Problem Solving',
          items: [
            { title: 'Optimization', desc: 'Maximize profit, minimize cost' },
            { title: 'Mixture Problems', desc: 'Combining different concentrations' },
            { title: 'Rate Problems', desc: 'Different speeds, times, distances' },
            { title: 'Work Problems', desc: 'Combined work rates' }
          ]
        },
        quiz: {
          question: 'First step in algebraic problem solving?',
          options: ['Write equation', 'Identify variables', 'Solve equation', 'Check answer'],
          answerIndex: 1,
          hint: 'Define what you need to find.'
        }
      }
    ]
  },
